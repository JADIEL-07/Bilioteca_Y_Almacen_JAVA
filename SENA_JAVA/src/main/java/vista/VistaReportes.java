...
public class VistaReportes extends JPanel {
    ...
    public VistaReportes() {
        ...
        JLabel subtitulo = new JLabel("Visualiza métricas, exporta informes de inventario y préstamos");
        ...
        JLabel lblEnConstruccion = new JLabel("El módulo de reportes avanzados estará disponible en futuras actualizaciones.", SwingConstants.CENTER);
